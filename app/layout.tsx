  ...
  return (
    <html lang="en">
      <body className={`${inter.className} bg-slate-50`}>
        ...
        <div className="bg-[#cad6ff] absolute top-[-6rem] -z-10 right-[11rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem]"></div>
        <Header/>
        {children}
      </body>
    </html>
